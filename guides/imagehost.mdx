...
<Step>
Make sure **haunt.gg - image host** appears in the list on the left, and that the API key is included in the request body on the right.
...
<Steps>
  ...
  <Step title="Done">
    Youre all set! All files that contain the trigger will be automatically added to the folder you set.
  </Step>
</Steps>
