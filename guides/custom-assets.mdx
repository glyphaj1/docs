  ...
  {[
    {
      ...
      desc: "Learn how to preview and apply custom assets to your profile."
    },
    {
      title: "Asset Types",
      icon: "circle-2",
      href: "../guides/custom-assets#available-asset-types",
      desc: "Explore the types of assets you can customize."
    },
    {
      title: "Upload Your Own Assets",
      icon: "circle-3",
      href: "../guides/custom-assets#uploading-your-own-assets",
      desc: "Share your custom assets with the haunt.gg community."
    }
  ].map(({ title, icon, href, desc }) => (
    <Card key={title} title={title} icon={icon} href={href} horizontal>
      {desc}
    </Card>
  ))}
</div>
